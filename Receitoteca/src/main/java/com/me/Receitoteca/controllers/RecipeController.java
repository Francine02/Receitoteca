...
public class RecipeController {
        ...
        @Operation(summary = "Criar uma receita", description = "Cria uma nova receita culinária com os detalhes fornecidos.", tags = {
                        "Receitas" }, responses = {
                                        @ApiResponse(description = "Receita criada com sucesso.", responseCode = "201", content = @Content(mediaType = "application/json", schema = @Schema(implementation = RecipeDTO.class), examples = @ExampleObject(value = "{\"id\":1,\"title\":\"Bolo de Cenoura\",\"ingredients\":[\"Farinha\",\"Ovos\",\"Cenoura\"],\"description\":\"Bolo clássico de cenoura\",\"imgUrl\":\"http://image.url\",\"prepTime\":20,\"cookTime\":35,\"category\":\"DESSERTS\",\"difficulty\":\"EASY\"}"))),
